...
class UserProfile(models.Model):
    belong_to = models.OneToOneField(to=User, max_length=100, related_name="profile")
    avatar = models.ImageField(upload_to='profile_image/', default='profile_image/IMG_2632.JPG')
    SEX_CHOICES = (
        ('F', 'Female',),
        ('M', 'Male',),
        ('U', 'Other',),
